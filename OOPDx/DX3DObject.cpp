...
bool DX3DObject::Init(int screenWidth, int screenHeight, bool vsync, HWND hwnd, bool fullscreen,
...
void DX3DObject::BeginScene(Color color)
{
	if(!isInited) return;
	static float rgba[4];	
...
void DX3DObject::GetVideoCardInfo(char* cardName, int& memory) const
{
...
ID3D11Device* DX3DObject::GetDevice() const
{
	return m_device;
}

ID3D11DeviceContext* DX3DObject::GetDeviceContext() const
{
